...
public class QueueVehicleTypeAdapter extends ArrayAdapter<String> {
    ...
    public QueueVehicleTypeAdapter(Activity context, String[] title, String[] subtitle, Integer[] imageID) {
